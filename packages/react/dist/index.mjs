...
function Toast({ title, subtitle = "", closeToast, amountOfSecondsForCloseToast = 5 }) {
  ...
  return /* @__PURE__ */ jsxs4(ToastContainer, { children: [
    /* @__PURE__ */ jsxs4(TextContainer, { children: [
      /* @__PURE__ */ jsx5("h3", { children: title }),
      !!subtitle && /* @__PURE__ */ jsx5("span", { children: subtitle })
    ] }),
    /* @__PURE__ */ jsx5(X, { color: colors.gray200, style: { marginTop: "0.5rem", cursor: "pointer" }, size: 18, onClick: closeToast })
  ] });
}
...
function Tooltip(_a) {
  ...
  return /* @__PURE__ */ jsxs5(TooltipContainer, { modal: true, children: [
    /* @__PURE__ */ jsx6(TooltipTrigger, { children: triggerElement }),
    /* @__PURE__ */ jsxs5(TooltipContent, __spreadProps(__spreadValues({ side: "top" }, props), { children: [
      /* @__PURE__ */ jsx6(Text, { children: content }),
